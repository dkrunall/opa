...
export const metadata = {
  title: "Nightlife in Andheri | Best Club, Lounge & Cocktail Bar in Mumbai | OPA Bar & Cafe",
  description:
    "OPA Bar & Cafe — the best nightlife in Andheri East Mumbai. Best club, lounge bar & cocktail bar open till late night near Sakinaka. Live DJs, LIT cocktails, Arabian ambience & the best music. Pubs in Andheri East.",
  keywords: [
  ...
  openGraph: {
    ...
    url: "https://opabarandcafe.in/nightlife",
