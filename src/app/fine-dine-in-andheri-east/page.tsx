...
export const metadata = {
  title: "Best Fine Dining Restaurant in Andheri East, Mumbai | Opa bar & cafe",
  description:
    "Experience fine dining in Andheri East at Opa Bar & Cafe. Enjoy Mediterranean cuisine, signature cocktails, elegant ambience, and unforgettable dining experiences in Mumbai.",
  keywords: [
  ...
  openGraph: {
    ...
    url: "https://opabarandcafe.in/fine-dine-in-andheri-east",
...
const breadcrumb = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Fine Dine", "item": "https://opabarandcafe.in/fine-dine-in-andheri-east" },
  ],
};
